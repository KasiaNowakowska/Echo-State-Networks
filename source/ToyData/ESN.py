...
val      = RVC_Noise
N_fo     = 4                     # number of validation intervals
...
N_tstart = N_washout + N_train + 25   #where the first test interval starts
N_intt   = 50*N_lyap                #length of each test set interval
        ...
        if plot:
            ...
            if i<n_plot:
                if ensemble_test % 1 == 0:
                    ...
                    plot_reconstruction(reconstructed_truth, reconstructed_predictions, 32, 20, xx, 'test%i' %i)
                    ...
                    output_file = name + '_ESN_test_metrics_test%i.json' % i
