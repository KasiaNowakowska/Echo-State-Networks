...
sweep_id = wandb.sweep(sweep=sweep_configuration, project="autoenoder_toydata_combined")
        ...
        for j in range(n_batches):
            ...
            if j == 0:
                if (epoch % N_check == 0):
                    ...
                    plot_reconstruction(original_unscaled, decoded_unscaled, 32, 20, name)
                    ax.set_xlabel('epochs')
                    ax.legend()
                    fig.savefig(images_dir +'/train_recons.png')
        ...
        if (epoch%N_check==0):
            ...
            for j in range(val_batches):
                ...
                if j == 0:
                    ...
                    ax.set_xlabel('epochs')
                    ax.legend()
                    fig.savefig(images_dir +'/val_recons.png')
