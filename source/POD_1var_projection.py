...
output_path1 = '/nobackup/mm17ktn/ESN/Echo-State-Networks/source/POD_Analysis/1variables_projection/analysis/'
...
for snap in num_snapshots:
    ...
    data_all         = w_array.reshape(len(time_vals),  len(x) , len(z) , variables)
